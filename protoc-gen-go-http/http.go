...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/go-warrior/pkg/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/go-warrior/pkg/transport/http/binding")
)
